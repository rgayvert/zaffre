import { core, Box, HDivider, Page, place } from "zaffre";
import { Spacer, mergeComponentOptions, ToastStack, BV, restoreOptions } from "zaffre";
...
defineComponentBundle<ToDoOptions>("ToDo", "Page", {
  maxWidth: ch(100),
  width: pct(100),
});
